<script lang="ts">
	...
	const homeHref = $derived(localizeInternalHref('/', resolveLocale(getLocale())));
</script>
...
<main class="mx-auto flex w-full max-w-6xl flex-grow flex-col px-4 sm:px-6 lg:px-8">
	<div class="my-auto flex-shrink-0 py-16 sm:py-32">
		...
		<div class="mt-6">
			<a href={homeHref} class="text-primary-600 hover:text-primary-500 text-base font-medium">
